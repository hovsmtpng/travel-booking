                            ...
                            <div class="iq-card-body p-0 ">
                                    ...
                                    <div class="media align-items-center">
                                        <div class="">
                                            <img class="avatar-40 rounded"
                                                src="<?php echo base_url('assets/dashboard/images/user/01.jpg')?>"
                                                alt="">
                                        </div>
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="media align-items-center">
                                        <div class="">
                                            <img class="avatar-40 rounded"
                                                src="<?php echo base_url('assets/dashboard/images/user/02.jpg')?>"
                                                alt="">
                                        </div>
                                        <div class="media-body ml-3">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="media align-items-center">
                                        <div class="">
                                            <img class="avatar-40 rounded"
                                                src="<?php echo base_url('assets/dashboard/images/user/03.jpg')?>"
                                                alt="">
                                        </div>
                                        <div class="media-body ml-3">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="media align-items-center">
                                        <div class="">
                                            <img class="avatar-40 rounded"
                                                src="<?php echo base_url('assets/dashboard/images/user/04.jpg')?>"
                                                alt="">
                                        </div>
                                        <div class="media-body ml-3">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="media align-items-center">
                                        <div class="">
                                            <img class="avatar-40 rounded"
                                                src="<?php echo base_url('assets/dashboard/images/user/05.jpg')?>"
                                                alt="">
                                        </div>
                                        <div class="media-body ml-3">
                            ...
                            <div class="iq-card-body p-0 ">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="media align-items-center">
                                        <div class="">
                                            <img class="avatar-40"
                                                src="<?php echo base_url('assets/dashboard/images/small/jpg.svg')?>"
                                                alt="">
                                        </div>
                                        <div class="media-body ml-3">
        ...
        <ul class="navbar-list">
            <li>
                <a href="#" class="search-toggle iq-waves-effect bg-primary text-white"><img
                        src="<?php echo base_url('assets/dashboard/images/user/1.jpg')?>" class="img-fluid rounded"
                        alt="user"></a>
                <div class="iq-sub-dropdown iq-user-dropdown">
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height shadow-none m-0">
                        <div class="iq-card-body p-0 ">
                            <div class="bg-primary p-3">
                                <h5 class="mb-0 text-white line-height">Hello <?php echo(session()->get('fullname'))?>
                                </h5>
                                <span class="text-white font-size-12"><?php echo(session()->get('level'))?></span>
                            </div>
                            ...
                            <div class="d-inline-block w-100 text-center p-3">
                                <a class="iq-bg-danger iq-sign-btn" href="<?php echo base_url('CLogin/logout')?>"
                                    role="button">Sign
